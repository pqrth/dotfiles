# Generated by Powerlevel10k configuration wizard on 2026-05-23 at 01:47 PDT.
...
() {
  ...
  # Context color when running under sudo without full root.
  typeset -g POWERLEVEL9K_CONTEXT_SUDO_FOREGROUND=1
  typeset -g POWERLEVEL9K_CONTEXT_SUDO_BACKGROUND=0
